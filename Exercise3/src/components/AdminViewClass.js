...
class AdminView extends React.Component {
  ...
  addNewItem = () => {
    this.props.addNewItem(this.state.newItemName, this.state.newItemBrand, this.state.newItemPrice);
  }
    ...
    return (
      <div>
        <div>
            ...
            <div>
              Brand <input type="text" onChange={ (event) => this.setState({ newItemBrand: event.target.value }) } />
            </div>
            <div>
